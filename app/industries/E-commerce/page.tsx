        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="max-w-5xl mx-auto px-6 py-16 text-center">
                ...
                <p className="text-gray-700 text-lg mb-6">
                    Robust solutions for online stores, payment gateways, and order management
                    to streamline your e-commerce operations.
                </p>
                <p className="text-gray-700 text-lg">
                    Deliver seamless customer journeys, track inventory, and scale your
