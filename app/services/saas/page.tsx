        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="max-w-5xl mx-auto px-6 py-16 text-center">
                ...
                <p className="text-gray-700 text-lg mb-6">
                    Build cloud-based software tailored to your business model and users.
                </p>
                <p className="text-gray-700 text-lg">
                    We focus on subscription systems, admin dashboards, and reliable cloud
                    deployment to support recurring revenue platforms.
                </p>
            </section>
