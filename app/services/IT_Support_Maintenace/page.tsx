...
export default function ITSupportMaintenancePage() {
    const data = services.find(
        (service) => service.title === "IT Support & Maintenance"
    );
    ...
    return (
        <main className="min-h-screen bg-white">
            ...
            {/* <section className="bg-[#17a28f] text-white py-24 px-6 text-center">
                <h1 className="text-4xl font-bold mb-4 text-[#262e31]">
                    {data.title}
                </h1>
            ...
            <section className="max-w-5xl mx-auto px-6 py-16 text-center">
                <h2 className="text-3xl font-semibold mb-6  text-[#262e31]">
                    Reliable IT Support & Maintenance
                </h2>
                <p className="text-gray-700 text-lg mb-6">
                    Keep your business running smoothly with proactive monitoring and support.
                </p>
                <p className="text-gray-700 text-lg">
                    We handle bug fixes, software updates, and technical support
                    to minimize downtime and ensure continuity.
                </p>
            </section>

            {/* Items */}
            <section className="max-w-7xl mx-auto px-6 py-20 relative bg-cover bg-center " style={{
                backgroundImage: "url('/IT.jpg')"
            }}>
