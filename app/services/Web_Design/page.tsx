        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="max-w-5xl mx-auto px-6 py-16 text-center">
                ...
                <p className="text-gray-700 text-lg mb-6">
                    Create strong first impressions with visually stunning, responsive web designs.
                </p>
                <p className="text-gray-700 text-lg">
                    Our design approach focuses on usability, brand identity, and user experience
                    to deliver websites that engage and convert.
                </p>
            </section>
