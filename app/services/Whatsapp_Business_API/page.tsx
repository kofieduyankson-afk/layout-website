...
export default function WhatsApp_Business_APIPage() {
    const data = services.find(
        (service) => service.title === "WhatsApp Business API"
    );
        ...
        <main className="min-h-screen bg-white">
            ...
            <section className="max-w-5xl mx-auto px-6 py-16 text-center">
                ...
                <p className="text-gray-700 text-lg mb-6">
                    Leverage the official WhatsApp Business API for customer support and notifications.
                </p>
                <p className="text-gray-700 text-lg">
                    Build chatbots, automate messaging, and integrate with your systems
