    ...
    return (
        <div className="flex flex-col justify-center min-h-[260px] px-6 text-center lg:text-left space-y-6">
            ...
            <div className="relative h-14 overflow-hidden">
                <p
                    className={`inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#17a28f]/10 text-[#17a28f] font-bold text-sm uppercase tracking-widest leading-relaxed max-w-2xl transition-all duration-700 ease-out transform
